  ...
  var init_es = __esm({
    "node_modules/i18next-icu/dist/es/index.js"() {
      ...
      ICU = /* @__PURE__ */ (function() {
        ...
        _createClass(ICU2, [{
          key: "init",
          value: function init2(i18next2, options2) {
            var _this = this;
...
web sitelerine tercihinizi iletiriz:`,
  ...
  var require_eventemitter2 = __commonJS({
    "node_modules/eventemitter2/lib/eventemitter2.js"(exports, module) {
      !(function(undefined2) {
        ...
        function TargetObserver(emitter, target, options2) {
          this._emitter = emitter;
          this._target = target;
          this._listeners = {};
          this._listenersCount = 0;
          var on, off;
          if (options2.on || options2.off) {
            on = options2.on;
            off = options2.off;
          }
        ...
        function resolveOptions(options2, schema, reducers, allowUnknown) {
          var computedOptions = Object.assign({}, schema);
          if (!options2) return computedOptions;
        ...
        function makeCancelablePromise(Promise2, executor, options2) {
          var isCancelable;
          var callbacks;
          var timer = 0;
          var subscriptionClosed;
          var promise = new Promise2(function(resolve, reject, onCancel) {
            options2 = resolveOptions(options2, {
              timeout: 0,
              overload: false
            }, {
            ...
            isCancelable = !options2.overload && typeof Promise2.prototype.cancel === "function" && typeof onCancel === "function";
            function cleanup() {
              if (callbacks) {
                callbacks = null;
              }
        ...
        function setupListener(event, listener, options2) {
          if (options2 === true) {
            promisify = true;
            ...
            var async = options2.async;
            var promisify = options2.promisify;
            var nextTick = options2.nextTick;
            var objectify = options2.objectify;
          }
        ...
        EventEmitter2.prototype.listenTo = function(target, events, options2) {
          ...
          function listen(events2) {
            ...
            var observer;
            if (index === -1) {
              observer = new TargetObserver(emitter, target, options2);
            } else {
        ...
        EventEmitter2.prototype.once = function(event, fn, options2) {
          return this._once(event, fn, false, options2);
        };
        EventEmitter2.prototype.prependOnceListener = function(event, fn, options2) {
          return this._once(event, fn, true, options2);
        };
        EventEmitter2.prototype._once = function(event, fn, prepend, options2) {
          return this._many(event, 1, fn, prepend, options2);
        };
        EventEmitter2.prototype.many = function(event, ttl, fn, options2) {
          return this._many(event, ttl, fn, false, options2);
        };
        EventEmitter2.prototype.prependMany = function(event, ttl, fn, options2) {
          return this._many(event, ttl, fn, true, options2);
        };
        EventEmitter2.prototype._many = function(event, ttl, fn, prepend, options2) {
          var self2 = this;
          ...
          listener._origin = fn;
          return this._on(event, listener, prepend, options2);
        };
        ...
        EventEmitter2.prototype.on = function(type, listener, options2) {
          return this._on(type, listener, false, options2);
        };
        EventEmitter2.prototype.prependListener = function(type, listener, options2) {
          return this._on(type, listener, true, options2);
        };
        ...
        EventEmitter2.prototype._on = function(type, listener, prepend, options2) {
          ...
          if (options2 !== undefined2) {
            temp = setupListener.call(this, type, listener, options2);
            listener = temp[0];
            returnValue = temp[1];
          }
        ...
        EventEmitter2.prototype.waitFor = function(event, options2) {
          var self2 = this;
          var type = typeof options2;
          if (type === "number") {
            options2 = { timeout: options2 };
          ...
          return makeCancelablePromise(options2.Promise, function(resolve, reject, onCancel) {
            function listener() {
            ...
            overload: options2.overload
          });
        };
        function once(emitter, name, options2) {
          options2 = resolveOptions(options2, {
            Promise,
            timeout: 0,
            overload: false
  ...
  var init_ui_wrapper = __esm({
    "shared/js/ui/base/ui-wrapper.js"() {
      ...
      sendMessage = async (messageType, options2) => {
        return await import_webextension_polyfill2.default.runtime.sendMessage({ messageType, options: options2 });
      };
  ...
  var require_model = __commonJS({
    "shared/js/ui/base/model.js"(exports, module) {
      ...
      BaseModel2.prototype = $.extend({}, mixins2.events, {
         ...
         **/
        sendMessage(messageType, options2) {
          return browserUIWrapper.sendMessage(messageType, options2);
        },
        /**
         * Send a user action
